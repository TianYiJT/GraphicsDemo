...
void Render_Object_other(int type)
{
...
void displayFBO_other()
{
	glBindFramebuffer(GL_FRAMEBUFFER, DEPTHFBO[0]);
	Render_Object_other(1);
...
void display_other() 
{
	...
	Render_Object_other(3);
	glEnd();
	glutSwapBuffers();
}
void myReshape_other(int w, int h)
{
